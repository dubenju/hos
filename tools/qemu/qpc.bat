...
.\qemu.exe -L . -m 32 -localtime -no-kqemu -std-vga -boot a -fda .\qemu_img\Dosv6.22.IMg -hda C:\Users\DBJ\git\hos\tools\qemu\qemu_img\format\qcow2_20m_ds.qcow2 -soundhw sb16,pcspk -net nic
