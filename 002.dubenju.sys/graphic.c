  ...
  int i;
    ...
    if (binfo->vmode == 8) {
        ...
        for (b = 0; b < 6; b++) {
            for (g = 0; g < 6; g++) {
                for (r = 0; r < 6; r++) {
                    ...
                    table_16_65536[r + g * 6 + b * 36 + 16] = r + g * 6 + b * 36 + 16;
                }
            }
        }
        ...
        for (o = 0; o < 16; o ++) {
            ...
            table_16_65536[o] = (unsigned short) (((table_rgb[o * 3 + 2] << 11) & 0xf800) | ((table_rgb[o * 3 + 1] << 4) & 0x07e0) | (table_rgb[o * 3 + 0] & 0x001f));
        }
        table_16_65536[0] = 0; /* COL8_000000 */
        table_16_65536[1] = 0xF800; /* COL8_FF0000 */
        table_16_65536[2] = 0x07E0; /* COL8_00FF00 */
        table_16_65536[3] = 0xFFE0; /* COL8_FFFF00 */
        table_16_65536[4] = 0x001F; /* COL8_0000FF */
        table_16_65536[5] = 0xF81F; /* COL8_FF00FF */
        table_16_65536[6] = 0x07FF; /* COL8_00FFFF */
        table_16_65536[7] = 0xFFFF; /* COL8_FFFFFF */
        table_16_65536[8] = 0x79EF; /* COL8_C6C6C6 */
        table_16_65536[9] = 0x3800; /* COL8_840000 */
        table_16_65536[10] = 0x00E0; /* COL8_008400 */
        table_16_65536[11] = 0x38E0; /* COL8_848400 */
        table_16_65536[12] = 0x0007; /* COL8_000084 */
        table_16_65536[13] = 0x3807; /* COL8_840084 */
        table_16_65536[14] = 0x00E7; /* COL8_008484 */
        table_16_65536[15] = 0x38E7; /* COL8_848484 */
...
void putfonts8_asc(short *vram, int xsize, int x, int y, unsigned char c, char scl, unsigned char *s) {
  ...
  char *nihongo = (char *) *((int *) ADR_LANG), *font;
  int k, t;
